...
export default function WalletButton({
  ...
  return (
    <div
      ...
      id="wallet-interactive-badge-container"
    >
      {/* Wallet Chip trigger */}
      <button
        onClick={() => setDropdownOpen(!dropdownOpen)}
        className={` h-9 max-w-[140px]  bg-[#161A22]/60 hover:bg-[#161A22] border border-[#262B36] hover:border-[#C7FF4D]/35 transition-all py-1.5 px-2.5 sm:px-3.5 rounded-xl flex items-center gap-2 cursor-pointer select-none ${className} hidden md:inline-block`}
      ...
      >
        ...
        <span className=" hidden text-[10.5px] text-[#C7FF4D] font-mono font-extrabold bg-[#C7FF4D]/10 px-2 py-0.5 rounded-lg border border-[#C7FF4D]/20 leading-none shrink-0 whitespace-nowrap">
